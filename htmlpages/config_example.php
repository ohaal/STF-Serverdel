...
$config['lang_no_signedupforteam'] = 'Du er nå påmeldt laget $teamname$!';
$config['lang_no_createdandsignedupforteam'] = 'Laget $teamname$ er nå opprettet og du er påmeldt dette laget!';
$config['lang_no_invalidanswerprovided'] = 'Du må angi et gyldig svaralternativ!';
$config['lang_no_invalidquestionnumberoranswer'] = 'Du har oppgitt et ugyldig spørsmål- eller svaralternativ!';
$config['lang_no_registeredanswer'] = 'Ditt svar ($answer$) på spørsmål $questionnumber$ er registrert!';
